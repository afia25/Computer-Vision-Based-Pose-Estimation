...
class Application:
    ...
    def __init__(self):
        ...
        self.model = load_model('D:/Study Materials/Fourth Year First Semester/CSE 410/Final Project/cnn8grps_rad1_model.h5')
        ...
        self.root = tk.Tk()
        self.root.title("Translate Page")
        ...
        self.T.place(x=530, y=5)
        self.T.config(text="Gesture Translator", font=("Courier", 40, "bold"), fg='red')
    ...
    def video_loop(self):
        try:
            ...
            if hands:
                ...
                white = cv2.imread("D:/Study Materials/Fourth Year First Semester/CSE 410/Final Project/white.jpg")
